...
db:hset(hash, user_id, 'true')
 ...
 api.sendMessage('120747751', '`کاربر '..user_id..' چت را آغاز کرد.`', true)
 end
end
...
api.sendMessage('120747751', '`کاربر '..user_id..' چت را پایان داد.`', true)
end
end
if msg.chat.type == 'private' and chat_info == 'true' then
if blocks[1] == 'end' or blocks[1] == 'chat' then return nil end
api.forwardMessage('120747751', msg.chat.id, msg_id) 
...
api.sendMessage('120747751', 'ارسال شد!', true)
end
if blocks[1] == 'help' and msg.chat.type == 'private' and msg.chat.id == 120747751 then
local text = [[Hi 
		*** Bot Admins Help ***
*/block reply|userid
...
if msg.reply and msg.reply.forward_from and msg.chat.type == 'private' and msg.chat.id == 120747751 and not blocks[2] then
msg = msg.reply
...
api.sendMessage(user_id, '`- متاسفم`\n`داخل این بات بلاک شدی`\n`چت تمام شد!`', true) 
 ...
 if msg.chat.type == 'private' and msg.chat.id == 120747751 then
...
api.sendMessage(user_id, '`شما انبلاک شدید و قابلیت چت کردن دارید`', true) 
 ...
 if msg.chat.type == 'supergroup' and msg.chat.id == 120747751 then
  if msg.reply then return nil end
local user_id = blocks[2]
 db:hset(hash, user_id, 'false')
api.sendMessage(msg.chat.id, '`از بلاک خارج شد '..user_id..' کاربر`', true) 
api.sendMessage(user_id, '`شما انبلاک شدید و قابلیت چت کردن دارید`', true) 
    ...
    if msg.reply and msg.reply.forward_from and msg.chat.type == 'private' and msg.chat.id == 120747751 then
